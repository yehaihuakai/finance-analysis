package com.dion.utils.shaUtils;
...
public class SHAUtil {
    ...
    private static void dotest() {
        String key = "key";
        String data = "data";
        System.out.println("hex_sha1(" + data + ")=" + encryptSHA(data));
    ...
    private static boolean sha1_vm_test() {
        return hexcase ? encryptSHA("abc").equals("a9993e364706816aba3e25717850c26c9cd0d89d") : encryptSHA("abc").equals(
...
//        paraMap.put("phone","15019210890");
//        paraMap.put("accountNo", "123456789123456789");
//        paraMap.put("accountName", "张三");
//        paraMap.put("cardId","232326199103052635");
//
//        //对参数进行加密组装
//        String key = formatUrlMap(paraMap);
        String key = "孙笔锋621700720001548819314414221987072931772business/repayment/repaymentCallbacknull1708031637300200905021372345288110001";
        System.out.println(key);
//        String keySHA = encryptSHA(key);
